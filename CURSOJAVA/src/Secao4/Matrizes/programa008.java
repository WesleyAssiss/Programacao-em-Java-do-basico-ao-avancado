...
8 -> Leia uma matriz de 3x3 elementos.Calcule a soma dos elementos que estão acima da
diagonal principal.
...
public class programa008 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Soma dos elementos que estão acima da diagonal principal");
        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz.length; j++) {
